        ...
        <div className="flex items-center space-x-2">
          {activeFilterCount > 0 && (
            <button
              ...
              className="text-sm text-slate-700 hover:text-slate-900 font-medium whitespace-nowrap"
            >
              Clear All
            </button>
          )}
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <input
                  ...
                  className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg text-sm focus:border-slate-700 focus:ring-2 focus:ring-slate-200"
                  placeholder="Min"
                />
