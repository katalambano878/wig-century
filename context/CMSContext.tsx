...
const defaultSettings: SiteSettings = {
    site_name: 'Luxury Loots GH',
    site_tagline: 'Thrifted Tops · African Print · Watches & Sunglasses',
    site_logo: '/logo.png',
    contact_email: '',
    contact_phone: '0535227192',
    contact_address: 'Obuasi, Ashanti Region, Ghana',
    social_facebook: '',
    social_instagram: 'https://www.instagram.com/luxurylootsgh',
    social_twitter: '',
    social_tiktok: 'https://www.tiktok.com/@adjoa.ae',
    social_snapchat: 'https://snapchat.com/add/adjoa.ae',
    social_youtube: '',
