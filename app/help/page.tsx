      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center bg-blue-100 rounded-full mx-auto mb-4">
                <i className="ri-arrow-left-right-line text-3xl text-blue-700"></i>
              </div>
              ...
              <span className="text-blue-700 font-semibold whitespace-nowrap">Initiate Return →</span>
            </Link>
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center bg-blue-100 rounded-full mx-auto mb-4">
                <i className="ri-map-pin-line text-3xl text-blue-700"></i>
              </div>
              ...
              <span className="text-blue-700 font-semibold whitespace-nowrap">Track Now →</span>
            </Link>
          </div>
        </div>
      </main>
