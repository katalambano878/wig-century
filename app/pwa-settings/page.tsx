  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-slate-700 hover:text-slate-800 mb-6 whitespace-nowrap"
        >
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
              <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
                <i className="ri-notification-line text-blue-700"></i>
              </div>
              Notifications
            </h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                ...
                {notificationPermission === 'default' && (
                  <button
                    ...
                    className="px-4 py-2 bg-blue-700 text-white rounded-lg hover:bg-blue-800 transition-colors whitespace-nowrap"
                  >
                    Enable
                  </button>
                )}
              ...
              {notificationPermission === 'granted' && (
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
                  <p className="text-sm text-slate-800 font-medium mb-2">You will receive notifications for:</p>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-slate-50 rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-rocket-line text-slate-700 text-xl"></i>
                  <span className="font-semibold text-slate-900">Fast Loading</span>
                </div>
                <p className="text-sm text-slate-800">Instant page loads with smart caching</p>
              </div>
              <div className="p-4 bg-blue-50 rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-home-line text-blue-700 text-xl"></i>
                  <span className="font-semibold text-blue-900">Home Screen</span>
                </div>
                <p className="text-sm text-blue-800">Add to home screen like a native app</p>
              </div>
